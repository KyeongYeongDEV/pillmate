    ...
    private HttpStatus resolveStatus(ErrorCode code) {
        return switch (code) {
            ...
            case GROUP_INVITE_CODE_USED, GROUP_ALREADY_MEMBER, SCHEDULE_CONFLICT,
                 SCHEDULE_PERIOD_ENDED, DOSE_LOG_DATE_LOCKED, DOSE_LOG_ALREADY_CHECKED -> HttpStatus.CONFLICT;
            case DRUG_SEARCH_EMPTY_QUERY, INVALID_REQUEST,
                 ...
                 OCR_REQUEST_INVALID, MEDICATION_SHARE_INVALID_TARGET -> HttpStatus.BAD_REQUEST;
