...
public enum ErrorCode {
    ...
    GROUP_MEMBER_LIMIT_EXCEEDED("PILL_018", "케어그룹은 최대 6명까지 참여할 수 있어요."),
    ...
    DOSE_LOG_ALREADY_CHECKED("PILL_042", "이미 처리된 복약 기록이라 알림을 보낼 수 없습니다."),
    ...
    PRAISE_TARGET_INVALID("PILL_071", "칭찬할 수 없는 활동입니다."),
