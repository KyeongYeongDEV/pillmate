...
class TestGeminiKeysProperty:
    def test_gemini_keys_returns_key1_when_only_key1_set(self):
        """GEMINI_API_KEY1 만 설정 시 [KEY1] 반환."""
        from app.core.config import Settings

        s = Settings(GEMINI_API_KEY1="AIzaKey1Primary")
    ...
    def test_gemini_keys_legacy_fallback_when_no_key1(self):
        ...
        s = Settings(GEMINI_API_KEY="AIzaLegacyOnly")
    ...
    def test_gemini_api_key1_field_default_is_empty(self):
        """GEMINI_API_KEY1 기본값 빈 문자열."""
        from app.core.config import Settings

        s = Settings()
        assert s.gemini_api_key1 == ""

    def test_gemini_api_key2_field_default_is_empty(self):
        """GEMINI_API_KEY2 기본값 빈 문자열."""
        from app.core.config import Settings

        s = Settings()
        assert s.gemini_api_key2 == ""
    ...
    def test_key2_plus_legacy_when_no_key1(self):
        ...
        s = Settings(GEMINI_API_KEY="AIzaLegacy", GEMINI_API_KEY2="AIzaKey2")
        keys = s.gemini_keys
