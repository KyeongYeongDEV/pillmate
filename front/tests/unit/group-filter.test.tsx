...
const G_PATIENT: MyGroupSummary = {
  ...
  memberCount: 3, membersPreview: [{ userId: 1, name: '아', color: null }, { userId: 2, name: '엄', color: null }, { userId: 3, name: '나', color: null }],
  lastActivity: null, unreadCount: 0, pinned: false,
};

const G_GUARDIAN: MyGroupSummary = {
  groupId: 2, name: '할머니 댁', role: 'GUARDIAN',
  memberCount: 3, membersPreview: [{ userId: 1, name: '할', color: null }, { userId: 2, name: '엄', color: null }, { userId: 3, name: '나', color: null }],
  lastActivity: null, unreadCount: 0, pinned: true,
};

const G_ADMIN: MyGroupSummary = {
  groupId: 3, name: '우리 가족', role: 'ADMIN',
  memberCount: 2, membersPreview: [{ userId: 1, name: '나', color: null }, { userId: 2, name: '동', color: null }],
  lastActivity: null, unreadCount: 0, pinned: false,
};

const G_PRIVATE: MyGroupSummary = {
  groupId: 4, name: '내 복약', role: 'ADMIN',
  memberCount: 1, membersPreview: [{ userId: 1, name: '나', color: null }],
  lastActivity: null, unreadCount: 0, pinned: false,
};
