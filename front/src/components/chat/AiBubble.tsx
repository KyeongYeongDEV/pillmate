...
function AiBubble({ message }: Props) {
  return (
    <View style={styles.row}>
      <Avatar name="P" tint={colors.primaryBase} size={32} />
...
const styles = StyleSheet.create({
  ...
  body: { flex: 1, maxWidth: 290 },
  senderLabel: { fontSize: 11, color: colors.labelAlternative, fontWeight: '600', marginBottom: 4 },
  bubble: {
    backgroundColor: colors.bgNormal, borderRadius: radius.r14,
    padding: space.s14, borderWidth: 1, borderColor: colors.line,
    gap: space.s8,
  },
  warningText: { fontSize: 13, fontWeight: '700', color: colors.orange40 },
  content: { fontSize: 14, color: colors.labelNormal, lineHeight: 22 },
  sourceSection: { borderTopWidth: 1, borderTopColor: colors.line, paddingTop: space.s10, gap: 4 },
  sourceHeader: { fontSize: 11, color: colors.labelAlternative, fontWeight: '600', marginBottom: 2 },
  ...
  sourceIdxText: { fontSize: 10, fontWeight: '700', color: colors.primaryNormal },
  sourceInfo: { flex: 1 },
  sourceOrg: { fontSize: 12, fontWeight: '600', color: colors.labelNormal },
  sourceDoc: { fontSize: 11, color: colors.labelAlternative, marginTop: 1 },
  consultFooter: { fontSize: 11, color: colors.labelAlternative, lineHeight: 16, borderTopWidth: 1, borderTopColor: colors.line, paddingTop: space.s8 },
});
